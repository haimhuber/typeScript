...
class POI {
    constructor(private name: string, private latitude: number, private longitude: number) { }
    ...
    public set checkLat(lat: number) {
    ...
    public get latitude1(): number {
        return this.latitude;
    }

    public get longitude1(): number {
